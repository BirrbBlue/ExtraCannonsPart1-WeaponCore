...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition RepeaterCannonWep => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "RepeaterCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Bofors", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
