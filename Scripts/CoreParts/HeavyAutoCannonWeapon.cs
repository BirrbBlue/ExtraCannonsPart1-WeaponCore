...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition HeavyAutocannonWep => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HeavyAutoCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Heavy Auto Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                HACAmmoBox, // Must list all primary, shrapnel, and pattern ammos.
            },
