...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AttackCannonShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "AutoAssaultCannonAmmo", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Attack Cannon Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            BackKickForce = 4700f, // Recoil. This is applied to the Parent Grid.
            ...
            {
                ModelName = "\\Models\\Weapons\\AttackShell.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
