...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition ChainCannonWep => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ChainCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Chain Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
