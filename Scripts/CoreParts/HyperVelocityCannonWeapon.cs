...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition HyperVelCannonWep => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HyperVelocityAssaultCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Hyper Velocity Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
