...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HACAmmoBox => new AmmoDef
        {
            AmmoMagazine = "HeavyAutocannonClip", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Heavy Auto Cannon Magazine", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
