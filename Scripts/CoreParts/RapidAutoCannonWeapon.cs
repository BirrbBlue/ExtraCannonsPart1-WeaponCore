...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition RapidAutoCannonWep => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "RapidAutoCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Light Auto Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                LACAmmoBox, // Must list all primary, shrapnel, and pattern ammos.
            },
