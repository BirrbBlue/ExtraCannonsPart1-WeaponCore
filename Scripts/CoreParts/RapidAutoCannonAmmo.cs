...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef LACAmmoBox => new AmmoDef
        {
            AmmoMagazine = "NATO_25x184mm", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Light Auto Cannon Magazine", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 90f, // Direct damage; one steel plate is worth 100.
            Mass = 1.0f, // In kilograms; how much force the impact will apply to the target.
