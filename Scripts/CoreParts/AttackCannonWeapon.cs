...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition AttackCannonWep => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AutoAssaultCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Attack Cannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
